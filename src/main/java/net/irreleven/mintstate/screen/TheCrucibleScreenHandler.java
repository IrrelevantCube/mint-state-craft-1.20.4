...
public class TheCrucibleScreenHandler extends ScreenHandler {
    private final Inventory inventory;
    private final PropertyDelegate propertyDelegate;
    public final TheCrucibleBlockEntity blockEntity;

    public TheCrucibleScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
    ...
    public TheCrucibleScreenHandler(int syncId, PlayerInventory playerInventory,
        ...
        this.addSlot (new Slot (inventory, 3, 106, 11));

        this.addSlot (new Slot (inventory, 4, 28, 59));
        this.addSlot (new Slot (inventory, 5, 54, 59));
        this.addSlot (new Slot (inventory, 6, 80, 59));
        this.addSlot (new Slot (inventory, 7, 106, 59));
        this.addSlot (new Slot (inventory, 8, 132, 59));
